...
class LineAPI {
  ...
  _qrCodeLogin() {
    ...
    this._client.getAuthQrcode(true, 'SmartMoe~',(err, result) => {
  ...
  _findAndAddContactsByMid(group, mid) {
    return this._client.findAndAddContactsByMid(0, mid);
  }
